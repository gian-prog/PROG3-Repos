...
fun main() {
    ...
    jsoup(listOf("Comment", "est", "votre", "banquette?"))
}
...
//    val doc = Jsoup.connect("https://info.cegepmontpetit.ca/3N5-Prog3/intraA24-2.html").get()
//
//    //Sélectioner balise body
//    val body = doc.body()
//
//    for(mot in mots)
//    {
//        //Créer le DIV
//        val newDiv = doc.createElement("div")
//        ///Ajouter le contenu dans le div
//        newDiv.text(mot)
//        body.appendChild(newDiv) // Ajouter le DIV au body
//    }
//
//    println(doc.html())


    //Autre méthode avec que du Jsoup

    val doc: Document = Jsoup.connect("https://info.cegepmontpetit.ca/3N5-Prog3/intraA24-2.html").get()
    val body: Element = doc.select("body").first()
